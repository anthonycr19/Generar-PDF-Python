...
urlpatterns = [
    ...
    url(r'^obter/$', views.generar_lote),
    url(r'^obterseccion/$', view_seccion.generar_lote_seccion),
    url(r'^obterzona/$', view_zona.generar_lote_zona),
    ...
    url(r'^obteraetab/$', views_tab.generar_lote),
    url(r'^obtersecciontab/$', view_seccion_tab.generar_lote_seccion),
    url(r'^obterzonatab/$', view_zona_tab.generar_lote_zona),
    url(r'^obtenermergeaestab/$', view_test.unir_aes_tab),
    url(r'^obtenermergesecctab/$', view_test.unir_secciones_tab),
    url(r'^obtenermergezonatab/$', view_test.unir_zona_tab),
    url(r'^obtenermergeaesesp/$', view_test.unir_aes_esp),
    url(r'^obtenermergeseccesp/$', view_test.unir_secciones_esp),
    url(r'^obtenermergezonasesp/$', view_test.unir_zona_esp),
